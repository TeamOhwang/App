...
//
//    @GetMapping("/profile/{userId}") // 회원 정보 조회
//    public ResponseEntity<UserProfileResponseDto> getMyProfile(@PathVariable Long userId) {
//        UserProfileResponseDto profile = mypageService.getMyProfile(userId);
